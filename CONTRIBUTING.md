# 👥 Contributing to React context selector
...
- Browse [existing issues](https://github.com/HichemTab-tech/react-context-selector/issues) to see if your issue or feature idea has already been raised.
- If your idea or issue hasn't been addressed, feel free to [create a new issue](https://github.com/HichemTab-tech/react-context-selector/issues/new).
...
2. Clone your forked repository:
    ...
    ```sh
    git clone https://github.com/YOUR_GITHUB_USERNAME/react-context-selector
    cd react-context-selector
    ```
